class BoardsController < ApplicationController
  ...
  def create
    ...
    content += "この内容を直接推測できないような5文字以下の見出しをtitle、内容の黒歴史の強さに応じて1〜1000までの数字をpriceとして返してください。\n"
    content += "特に恥ずかしくない場合0点にしてください。1000点の基準は前科があるレベルのことです。\n"
    content += "文字数や描写が具体的でなければ点数を大幅に下げてください、基本的に採点は極めて厳しくつけてください。あああなど適当な文字は0を返してください。"
